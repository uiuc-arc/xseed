...
def remove_seeds(file_path):
    ...
    for line in file:        
        ...
        line = line.replace(tensorflow_alias + ".random.set_random_seed(", "pass # " + tensorflow_alias + " .random.set_random_seed(")
        line = line.replace(tensorflow_alias + ".compat.v1.random.set_random_seed(", "pass # " + tensorflow_alias + " .compat.v1.random.set_random_seed(")
        line = line.replace(pytorch_alias + ".manual_seed(", "pass # " + pytorch_alias + " .manual_seed(")
        line = line.replace(pytorch_alias + ".cuda.manual_seed_all(", "pass # " + pytorch_alias + " .cuda.manual_seed_all(")
